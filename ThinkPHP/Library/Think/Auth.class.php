...
class Auth{
    ...
    protected $_config = array(
        ...
        'AUTH_GROUP'        => 'auth_group',        //auth_group',       用户组数据表名
        'AUTH_GROUP_ACCESS' => 'auth_group_access', //auth_group_access' 用户-用户组关系表
        'AUTH_RULE'         => 'auth_rule',         //auth_rule',        权限规则表
        'AUTH_USER'         => 'manager'             //member'            用户信息表
    );
